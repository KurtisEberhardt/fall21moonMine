...
namespace fall21moonMine
{
    class Program
    {
        ...
        class MoonMiner{
            ...
            public Dictionary<string, decimal> Stats {set; get;}
            ...
            public void goToShop(){
                inShop = true; 
                Console.Clear();
                Console.WriteLine("Whaddya buyin', stranga?");
                string message = "";
            ...
            public void BuyUpgrade(int shopIndex){
                ...
                if(Cheese >= item.Price){
                    ...
                    Console.WriteLine("Not enough cash, stranga!");
                }
